package com.grantingersoll.intell;
/**
...
public class Indexer {
  private transient static Log log = LogFactory.getLog(Indexer.class);
  ...
  public Indexer(SolrServer server) throws MalformedURLException {
